...
Write-Host ""
echo Launching Chucks Contract 1...
Start-Process powershell -ArgumentList @(
    "-NoExit",
    "-Command",
    "Write-Host 'Chucks Contract 1 - Running Tests' -ForegroundColor Green; cd '$PSScriptRoot\chucks-contract-1'; cargo test"
)

Start-Sleep -Seconds 2

Write-Host "Launching Chucks Contract 2..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList @(
    "-NoExit", 
    "-Command",
    "Write-Host 'Chucks Contract 2 - Running Tests' -ForegroundColor Blue; cd '$PSScriptRoot\chucks-contract-2'; cargo test"
)
...
Write-Host "  - Chucks Contract 1 (Green) - chucks-contract-1" -ForegroundColor Green
Write-Host "  - Chucks Contract 2 (Blue)  - chucks-contract-2" -ForegroundColor Blue
Write-Host ""
